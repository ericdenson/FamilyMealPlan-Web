    ...
    async saveRecipe() {
        ...
        try {
            ...
            igRows.forEach(row => {
                ...
                // The DB might require a string for shopping_category, so we auto-fill a fallback
                if (n) finalIngredients.push({ ingredient_name: n, shopping_category: 'Legacy Unused' });
            });
