...
const adminApp = {
    ...
    openRecipeEditor(id) {
        ...
        document.getElementById('edit-protein').value = recipe.protein !== undefined ? recipe.protein : "";
        document.getElementById('edit-carbs').value = recipe.carbs !== undefined ? recipe.carbs : "";
        document.getElementById('edit-fat').value = recipe.fat !== undefined ? recipe.fat : "";
        document.getElementById('edit-fiber').value = recipe.fiber !== undefined ? recipe.fiber : "";
    ...
    async saveRecipe() {
        ...
        try {
            ...
            const protein_grams = document.getElementById('edit-protein').value === "" ? null : parseInt(document.getElementById('edit-protein').value) || 0;
            const carbs_grams = document.getElementById('edit-carbs').value === "" ? null : parseInt(document.getElementById('edit-carbs').value) || 0;
            const fat_grams = document.getElementById('edit-fat').value === "" ? null : parseInt(document.getElementById('edit-fat').value) || 0;
            const fiber_grams = document.getElementById('edit-fiber').value === "" ? null : parseInt(document.getElementById('edit-fiber').value) || 0;
    ...
    async calculateCalories() {
        ...
        try {
            ...
            if (data && data.calories) {
                ...
                document.getElementById('edit-protein').value = data.protein !== undefined ? data.protein : "";
                document.getElementById('edit-carbs').value = data.carbs !== undefined ? data.carbs : "";
                document.getElementById('edit-fat').value = data.fat !== undefined ? data.fat : "";
                document.getElementById('edit-fiber').value = data.fiber !== undefined ? data.fiber : "";
