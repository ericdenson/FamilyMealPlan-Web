                ...
                <td>
                    <div class="recipe-thumb">
                        ...
                        <div>
                            ...
                            <span class="recipe-meta">${recipe.ingredients.length} Ingredients &nbsp; &nbsp; ${recipe.time} mins ${recipe.visibility === 'private' && recipe.authorEmail ? `&nbsp; &nbsp; <i class="fa-solid fa-lock"></i> Private: ${recipe.authorEmail}` : ''}</span>
                        </div>
                    </div>
                </td>
